...
export default function CoursesPage() {
    return (
        <div className="container my-6 px-12">
            <PageHeader
                title="My Courses"
                description="Access all the courses you've enrolled in. Continue learning at your own pace and track your progress anytime."
            />
...
async function getUserCourses(userId: string) {
    ...
    const courses = await db
        ...
        .leftJoin(
            CourseSectionTable,
            and(eq(CourseSectionTable.courseId, CourseTable.id), wherePublicCourseSections),
        )
        .leftJoin(
            LessonTable,
